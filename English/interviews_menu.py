# Form implementation generated from reading ui file 'C:\Git\Python_Modul_Week_2\Python_Modul_Week_2\pract-2\Python-Module-Week7\English\interviews_menu.ui'
#
...
"}")
        ...
        self.project_send_Button = QtWidgets.QPushButton(parent=self.centralwidget)
        self.project_send_Button.setGeometry(QtCore.QRect(290, 180, 241, 31))
        font = QtGui.QFont()
        font.setBold(True)
        self.project_send_Button.setFont(font)
        self.project_send_Button.setStyleSheet("QPushButton{\n"
"color:black;\n"
"background:white;\n"
"border-radius:10px;\n"
"font-weight:bold;\n"
...
"}")
        ...
        self.project_submitted_Button = QtWidgets.QPushButton(parent=self.centralwidget)
        self.project_submitted_Button.setGeometry(QtCore.QRect(20, 180, 241, 31))
        font = QtGui.QFont()
        font.setBold(True)
        self.project_submitted_Button.setFont(font)
        self.project_submitted_Button.setStyleSheet("QPushButton{\n"
"color:black;\n"
"background:white;\n"
"border-radius:10px;\n"
"font-weight:bold;\n"
...
"background:none")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.project_send_Button.setText(_translate("MainWindow", "PROJECT SEND CANDIDATES"))
        self.search_Button.setText(_translate("MainWindow", "SEARCH"))
        self.project_submitted_Button.setText(_translate("MainWindow", "PROJECT SUBMITTED CANDIDATES"))
        self.mainmenu_Button.setText(_translate("MainWindow", "MAIN MENU"))
        self.search_Line.setPlaceholderText(_translate("MainWindow", "Enter a Text to Search"))
