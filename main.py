...
if __name__ == "__main__":
    ...
    def applications_setup():
        ...
        set_table_data(applications_menu, "Applications.xlsx")
    ...
    def mentor_setup():
        ...
        set_table_data(mentor_menu, "Mentors.xlsx")
        ...
        mentor_menu.all_meetings.clicked.connect(
            lambda: set_table_data(mentor_menu, "Mentors.xlsx")
        )
    ...
    def interviews_menu_setup():
        ...
        set_table_data(interviews_menu, "Interviews.xlsx")
        ...
        interviews_menu.all_interviews.clicked.connect(
            lambda: set_table_data(interviews_menu, "Interviews.xlsx")
        )
    ...
    def setup_admin_control_menu():
        ...
        admin_control_menu.activity_check.clicked.connect(
            lambda: set_table_data(admin_control_menu, "Events.xlsx")
        )
        set_table_data(admin_control_menu, "Events.xlsx")
