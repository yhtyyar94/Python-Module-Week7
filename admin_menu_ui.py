...
"background-image: url(./assets/zemin-buyuk.jpg);")
        ...
        self.Basvurular_2 = QtWidgets.QPushButton(self.centralwidget)
...
"}")
        ...
        self.Mentor = QtWidgets.QPushButton(self.centralwidget)
...
"}")
        ...
        self.Anamenu = QtWidgets.QPushButton(self.centralwidget)
